...
vid_path = '/media/vahid/DATA/data/animl_data/cogvid_preproc_sub/videos/0CFuw_00_gs_center_to_bottom-left.mp4'
new_vid_rev_path = '/media/vahid/DATA/data/animl_data/cogvid_preproc_sub/videos/0CFuw_00_gs_center_to_bottom-left_.mp4'

# cogvid_data_path = '/media/vahid/DATA/data/animl_data/cogvid_preproc_sub_latents'
# prompt_txt_path = f'{cogvid_data_path}/prompts.txt'
# vid_txt_path = f'{cogvid_data_path}/videos.txt'
# sub_prompt_txt_path = f'{cogvid_data_path}/small_prompts.txt'
# sub_vid_txt_path = f'{cogvid_data_path}/small_videos.txt'
#
# prompt_list = load_list_from_txt(prompt_txt_path)
# video_list = load_list_from_txt(vid_txt_path)
# save_list_to_txt(sub_prompt_txt_path, prompt_list[::8])
# save_list_to_txt(sub_vid_txt_path, video_list[::8])
# video_list = load_list_from_txt(sub_vid_txt_path)
# new_dir = '/media/vahid/DATA/data/animl_data/cogvid_preproc_sub_latents_small'
# for vid_name in video_list:
#     vid_id = vid_name.split('/')[-1].split('.')[0]
#     file_list = glob.glob(f'{cogvid_data_path}/**/{vid_id}*')
#     for fl in file_list:
#         new_name = fl.replace(cogvid_data_path, new_dir)
#         os.makedirs(os.path.dirname(new_name), exist_ok=True)
#         shutil.copy(fl, new_name)
