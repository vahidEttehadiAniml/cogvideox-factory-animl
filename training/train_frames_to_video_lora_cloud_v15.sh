  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="/data/cogvideox-factory-animl/runs/cogvideox-lora-v1.5_guide_crop_49__steps_${steps}__learning-rate_${learning_rate}/"
