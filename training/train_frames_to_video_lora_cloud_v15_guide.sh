...
HEIGHT_BUCKETS="768 960 1280"
WIDTH_BUCKETS="1280 960 768"
FRAME_BUCKETS="49"
MAX_NUM_FRAMES="49"
LORA_RANK=256
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="/data/cogvideox-factory-animl/runs/cogvideox-lora-v1.5_keyframe_guide_crop_49__steps_${steps}__learning-rate_${learning_rate}/"

        cmd="accelerate launch --config_file $ACCELERATE_CONFIG_FILE --gpu_ids $GPU_IDS training/cogvideox_frames_to_video_lora.py \
          --pretrained_model_name_or_path /data/cogvideox-factory-animl/ckpt/CogVideoX1.5-5B-I2V_guide_half \
          --data_root $DATA_ROOT \
